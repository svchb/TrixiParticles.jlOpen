...
const nu_empirical=max(0.1*Δx_f, water_viscosity)
...
state_equation = StateEquationCole(; sound_speed, reference_density=water_density,
                                   exponent=7, background_pressure=10000, clip_negative_pressure=false)
...
fluid_system = EntropicallyDampedSPHSystem(tank.fluid, smoothing_kernel,
                                               ...
                                               sound_speed, viscosity=water_viscosity_model)
...
# air_system = EntropicallyDampedSPHSystem(air_in_tank, smoothing_kernel,
#                                                smoothing_length,
#                                                density_calculator=fluid_density_calculator,
#                                                sound_speed, viscosity=air_viscosity_model)
...
save_cb     = SolutionSavingCallback(; dt = 0.025, output_directory = "output/coastal_wave_spray_2d", prefix="edac_$resolution_factor")
