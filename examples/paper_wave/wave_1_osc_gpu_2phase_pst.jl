...
fluid_system = WeaklyCompressibleSPHSystem(tank.fluid, fluid_density_calculator,
                                        ...
                                        #    density_diffusion,
                                        #    transport_velocity=TransportVelocityAdami(tvf_pressure_water),
...
cbset       = CallbackSet(info_cb, save_cb, stepsize_cb, post_cb, ParticleShiftingCallback(), UpdateCallback())
